          ...
          <div className="row">
            <div className="col-sm-6 col-lg-3 p-b-50">
              ...
              <ul>
                <li className="p-b-10">
                  <Link href="/showroom">
                    <a className="stext-107 cl7 hov-cl1 trans-04">Bikini</a>
                  </Link>
                </li>
                <li className="p-b-10">
                  <Link href="/showroom">
                    <a className="stext-107 cl7 hov-cl1 trans-04">Corpiño</a>
                  </Link>
                </li>
                <li className="p-b-10">
                  <Link href="/showroom">
                    <a className="stext-107 cl7 hov-cl1 trans-04">Enteriza</a>
                  </Link>
                </li>
                <li className="p-b-10">
                  <Link href="/showroom">
                    <a className="stext-107 cl7 hov-cl1 trans-04">Tankini</a>
                  </Link>
                </li>
              </ul>
            </div>
            <div className="col-sm-6 col-lg-3 p-b-50">
              ...
              <ul>
                <li className="p-b-10">
                  <Link href="/locales">
                    <a className="stext-107 cl7 hov-cl1 trans-04">Locales</a>
                  </Link>
                </li>
                <li className="p-b-10">
                  <Link href="/nosotros">
                    <a className="stext-107 cl7 hov-cl1 trans-04">Reembolsos</a>
                  </Link>
                </li>
                <li className="p-b-10">
                  <Link href="/nosotros">
                    <a className="stext-107 cl7 hov-cl1 trans-04">Envios</a>
                  </Link>
                </li>
                <li className="p-b-10">
                  <Link href="/nosotros">
